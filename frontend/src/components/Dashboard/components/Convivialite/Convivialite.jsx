                                ...
                                <div className='px-6 py-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4'>
                                    ...
                                    <div className='flex flex-col sm:flex-row gap-3 w-full sm:w-auto'>
                                        ...
                                        <button
                                            ...
                                            className='bg-gradient-to-r from-amber-600 to-amber-700 text-white px-4 py-2 rounded-lg font-medium hover:from-amber-700 hover:to-amber-800 transition-all flex items-center gap-2'
                                        >
                                            <FaPlus />
                                                            ...
                                                            <tr key={item._id} className='hover:bg-gray-50 transition-colors'>
                                                                ...
                                                                <td className='px-6 py-4 whitespace-nowrap'>
                                                                    <div className="flex items-center">
                                                                        ...
                                                                        <span>{item.nomEspace || "Salle Convivialité"}</span>
                                                                    </div>
                                                                </td>
                                                                <td className='px-6 py-4 whitespace-nowrap'>
