...
const Multimedia = () => {
            ...
            <div className='min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 pt-20 px-4 sm:px-6 lg:px-8 pb-10'>
                    ...
                    <div className='mb-8 pt-6'>
                        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-6">
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <div className="h-10 w-10 rounded-full  from-blue-500 to-purple-600 flex items-center justify-center text-white font-bold">
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mb-8'>
                            <div className=' from-blue-500 to-blue-600 rounded-2xl p-6 text-white shadow-xl transform transition-transform hover:-translate-y-1'>
                            ...
                            <div className=' from-emerald-500 to-green-600 rounded-2xl p-6 text-white shadow-xl transform transition-transform hover:-translate-y-1'>
                                <div className='flex justify-between items-start'>
                                    <div>
                            ...
                            <div className=' from-purple-500 to-indigo-600 rounded-2xl p-6 text-white shadow-xl transform transition-transform hover:-translate-y-1'>
                                <div className='flex justify-between items-start'>
                                    <div>
                                ...
                                <div className='px-6 py-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4'>
                                    ...
                                    <div className='flex flex-col sm:flex-row gap-3 w-full sm:w-auto'>
                                        ...
                                        <button
                                            ...
                                            className=' from-blue-600 to-blue-700 text-white px-4 py-2 rounded-lg font-medium hover:from-blue-700 hover:to-blue-800 transition-all flex items-center gap-2'
                                        >
                                            <FaPlus />
                                            Ajouter une visite
                                        </button>
                                                    ...
                                                    {filteredClients.length > 0 ? (
                                                        filteredClients.map((item, index) => (
                                                            <tr key={item._id} className='hover:bg-gray-50 transition-colors'>
                                                                <td className='px-6 py-4 whitespace-nowrap'>
                                                                    <div className="flex items-center">
                                                                        <div className="h-10 w-10 rounded-full  from-green-500 to-emerald-600 flex items-center justify-center text-white font-bold mr-3">
                ...
                {visitesPourAujourdhui.length > 0 && (
                    <div className="max-w-7xl mx-auto mb-8">
                        <div className=" from-indigo-50 to-blue-50 border border-indigo-100 rounded-2xl p-6">
    ...
    <>
        ...
        <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 
            ...
            <div className="sticky top-0  from-blue-600 to-indigo-700 px-6 py-4">
                <div className="flex items-center justify-between">
           ...
           <form onSubmit={handleSubmit} className="px-6 py-6 space-y-6">
                                    ...
                                    <div className="pt-4 border-t">
                                        <button
                                            type="submit"
                                            className="w-full  from-blue-600 to-blue-700 text-white py-3 px-4 rounded-lg font-medium hover:from-blue-700 hover:to-blue-800 transition-all transform hover:-translate-y-0.5 active:translate-y-0"
                                        >
