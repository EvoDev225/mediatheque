...
router.get("/api/auth/toutUtilisateur",verificationJeton,verifierAdmin, afficherToutUtilisateur)
...
// ADMIN : désactiver
router.patch("/api/auth/desactiverUtilisateur/:id", verificationJeton,verifierAdmin , desactiverUtilisateur)

// ADMIN : réactiver
router.patch("/api/auth/reactiverUtilisateur/:id", verificationJeton,verifierAdmin , reactiverUtilisateur)
//Changer le niceau de sécurité
router.patch("/api/auth/changerNiveau/:id", verificationJeton,verifierAdmin , changerAutorisationEmploye)
